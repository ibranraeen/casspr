...
import (
	...
	"github.com/ibranraeen/casspr/internal/oauth/hyper"
...
var loginCmd = &cobra.Command{
	Aliases: []string{"auth"},
	Use:     "login [platform]",
	Short:   "Login Casspr to a platform",
	Long: `Login Casspr to a specified platform.
...
casspr login copilot

# Force re-authentication even if already logged in
casspr login -f copilot
  `,
