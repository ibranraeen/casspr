...
casspr update-providers https://example.com/providers.json
...
casspr update-providers --source=hyper

# Update Hyper from a custom URL
casspr update-providers --source=hyper https://hyper.example.com
`,
