...
import (
	...
	"github.com/ibranraeen/casspr/internal/lsp"
...
func TestCrushInfo_Options(t *testing.T) {
	...
	cfg := config.NewTestStore(&config.Config{
		...
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.casspr",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.casspr")
...
func TestCrushInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	...
	require.Contains(t, output, "casspr-config = builtin, loaded")
...
func TestCrushInfo_Skills_DisabledSkills(t *testing.T) {
	...
	require.Contains(t, output, "casspr-config = builtin, unloaded")
