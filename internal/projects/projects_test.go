...
func TestRegisterAndList(t *testing.T) {
	...
	t.Setenv("CASSPR_GLOBAL_DATA", filepath.Join(tmpDir, "crush"))

	// Test registering a project
	err := Register("/home/user/project1", "/home/user/project1/.casspr")
	if err != nil {
	...
	if projects[0].DataDir != "/home/user/project1/.casspr" {
		t.Errorf("Expected data_dir /home/user/project1/.casspr, got %s", projects[0].DataDir)
	}

	// Register another project
	err = Register("/home/user/project2", "/home/user/project2/.casspr")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
...
func TestRegisterUpdatesExisting(t *testing.T) {
	...
	err = Register("/home/user/project1", "/home/user/project1/.casspr-new")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/project1/.casspr-new" {
...
func TestRegisterWithParentDataDir(t *testing.T) {
	...
	// Register a project where .casspr is in a parent directory.
	// e.g., working in /home/user/monorepo/packages/app but .casspr is at /home/user/monorepo/.casspr
	err := Register("/home/user/monorepo/packages/app", "/home/user/monorepo/.casspr")
	if err != nil {
		t.Fatalf("Register failed: %v", err)
	}
	...
	if projects[0].DataDir != "/home/user/monorepo/.casspr" {
		t.Errorf("Expected data_dir /home/user/monorepo/.casspr, got %s", projects[0].DataDir)
	}
}
...
func TestRegisterWithExternalDataDir(t *testing.T) {
	...
	// Register a project where .casspr is in a completely different location.
